...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 01 2022 г., 01:46
...
(5, 5, 1, 4, '2.500', '420.00', '1050.00'),
(6, 5, 1, 11, '2.070', '418.75', '866.81'),
(8, 5, 1, 9, '1.000', '4248.00', '4248.00');
...
(2, 'Отправлен ', 0),
(3, 'В корзине покупок', 0),
(4, 'Отправлен в обработку', 0),
...
(1, 'Администратор сайта', 'ooolagoc@yandex.ru', 'admin', '$argon2id$v=19$m=65536,t=4,p=1$MnM0LllHeFU3SnVYeWhaSg$tBIx4Dv30s7VItM4AMo1stVmgPwOoY1FJaaYgIgRVnE', '2022-02-27 19:19:22'),
(5, 'Дмитрий Смирнов', 'dimas@mail.ru', 'dimas', '$argon2id$v=19$m=65536,t=4,p=1$bFJTTVZ1bVUwYWp2QllkSw$n6HDY3BHePW3th6HR4K3Hhv7+I8KjNnM8xWQ/e0kF9k', '2022-03-01 00:54:13');
...
--
ALTER TABLE `cart`
  MODIFY `cartid` int NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=9;
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderdetailid` int NOT NULL AUTO_INCREMENT COMMENT 'ID';

--
-- AUTO_INCREMENT для таблицы `orders`
--
ALTER TABLE `orders`
  MODIFY `orderid` int NOT NULL AUTO_INCREMENT COMMENT 'ID';
...
--
ALTER TABLE `users`
  MODIFY `userid` int NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=6;
